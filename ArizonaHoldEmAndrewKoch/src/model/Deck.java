/*
 * Author: Andrew Koch
 * Deck.java constructs a deck of cards containing all 52 cards found in a standard
 * deck and also deals a random card to all players and the community hand.
 */
