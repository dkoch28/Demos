/*
 * Author: Andrew Koch
 * PokerHandTest.java contains test cases for determining if one hand beats
 * another hand by the rules of poker. The test cases fully check the compareTo()
 * method in PokerHand.java as well as the enums in Rank.java and Card.java.
 * Lastly there are tests that make sure a proper error is sent when there a duplicate
 * cards found in hands.
 * 
 */
